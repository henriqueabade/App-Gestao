    ...
    if(condicaoSelect.value==='vista'){
      pagamentoBox.innerHTML=`
        <div class="relative w-40">
          <i data-perm="orc.item.edit"nput id="novoPrazoVista" name="prazo" type="number" min="0" placeholder=" " required class="peer w-full bg-input border border-inputBorder rounded-lg px-4 py-3 text-white placeholder-transparent focus:border-primary focus:ring-2 focus:ring-primary/50 transition" data-filled="false" />
