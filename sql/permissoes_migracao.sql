...
ALTER TABLE perm_mp ADD COLUMN IF NOT EXISTS acao_movimentos_view BOOLEAN NOT NULL DEFAULT FALSE;  -- mp.movimentos.view · Ver auditoria do insumo
...
ALTER TABLE perm_prod ADD COLUMN IF NOT EXISTS acao_movimentos_view BOOLEAN NOT NULL DEFAULT FALSE;  -- prod.movimentos.view · Ver movimentações
...
ALTER TABLE perm_pros ADD COLUMN IF NOT EXISTS acao_contact_add BOOLEAN NOT NULL DEFAULT FALSE;  -- pros.contact.add · Adicionar contato
ALTER TABLE perm_pros ADD COLUMN IF NOT EXISTS acao_contact_edit BOOLEAN NOT NULL DEFAULT FALSE;  -- pros.contact.edit · Editar contato
ALTER TABLE perm_pros ADD COLUMN IF NOT EXISTS acao_contact_remove BOOLEAN NOT NULL DEFAULT FALSE;  -- pros.contact.remove · Remover contato
ALTER TABLE perm_pros ADD COLUMN IF NOT EXISTS acao_interaction_add BOOLEAN NOT NULL DEFAULT FALSE;  -- pros.interaction.add · Registrar interação
ALTER TABLE perm_pros ADD COLUMN IF NOT EXISTS acao_note_add BOOLEAN NOT NULL DEFAULT FALSE;  -- pros.note.add · Adicionar nota
ALTER TABLE perm_pros ADD COLUMN IF NOT EXISTS acao_note_remove BOOLEAN NOT NULL DEFAULT FALSE;  -- pros.note.remove · Remover nota
ALTER TABLE perm_pros ADD COLUMN IF NOT EXISTS acao_campaign_manage BOOLEAN NOT NULL DEFAULT FALSE;  -- pros.campaign.manage · Gerenciar campanhas
ALTER TABLE perm_pros ADD COLUMN IF NOT EXISTS acao_convert BOOLEAN NOT NULL DEFAULT FALSE;  -- pros.convert · Converter em cliente
